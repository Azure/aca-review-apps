...
class ContainerAppsAuthConfigsImpl {
    ...
    listByContainerAppPagingAll(resourceGroupName, containerAppName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listByContainerAppPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listByContainerAppPagingPage(resourceGroupName, containerAppName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    get(resourceGroupName, containerAppName, authConfigName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, containerAppName, authConfigName, options }, getOperationSpec$6);
    }
    /**
    ...
    delete(resourceGroupName, containerAppName, authConfigName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, containerAppName, authConfigName, options }, deleteOperationSpec$6);
    }
    /**
...
class ContainerAppsImpl {
    ...
    get(resourceGroupName, containerAppName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, containerAppName, options }, getOperationSpec$5);
    }
    /**
    ...
    beginCreateOrUpdate(resourceGroupName, containerAppName, containerAppEnvelope, options) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, containerAppName, containerAppEnvelope, options }, createOrUpdateOperationSpec$5);
    ...
    beginDelete(resourceGroupName, containerAppName, options) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, containerAppName, options }, deleteOperationSpec$5);
            const poller = new coreLro.LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
    ...
    beginUpdate(resourceGroupName, containerAppName, containerAppEnvelope, options) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, containerAppName, containerAppEnvelope, options }, updateOperationSpec$2);
            const poller = new coreLro.LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
    ...
    listSecrets(resourceGroupName, containerAppName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, containerAppName, options }, listSecretsOperationSpec$1);
    }
    /**
...
class DaprComponentsImpl {
    ...
    listPagingAll(resourceGroupName, environmentName, options) {
        return tslib.__asyncGenerator(this, arguments, function* listPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = tslib.__asyncValues(this.listPagingPage(resourceGroupName, environmentName, options)), _c; _c = yield tslib.__await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
                }
            }
    ...
    get(resourceGroupName, environmentName, componentName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, environmentName, componentName, options }, getOperationSpec$4);
    }
    /**
    ...
    delete(resourceGroupName, environmentName, componentName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, environmentName, componentName, options }, deleteOperationSpec$4);
    }
    /**
...
class ManagedEnvironmentsImpl {
    ...
    get(resourceGroupName, environmentName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, environmentName, options }, getOperationSpec$3);
    }
    /**
    ...
    beginCreateOrUpdate(resourceGroupName, environmentName, environmentEnvelope, options) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, environmentName, environmentEnvelope, options }, createOrUpdateOperationSpec$3);
            const poller = new coreLro.LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
    ...
    beginDelete(resourceGroupName, environmentName, options) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, environmentName, options }, deleteOperationSpec$3);
            const poller = new coreLro.LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
    ...
    beginUpdate(resourceGroupName, environmentName, environmentEnvelope, options) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, environmentName, environmentEnvelope, options }, updateOperationSpec$1);
            const poller = new coreLro.LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
...
class CertificatesImpl {
    ...
    get(resourceGroupName, environmentName, certificateName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, environmentName, certificateName, options }, getOperationSpec$2);
    }
    /**
    ...
    createOrUpdate(resourceGroupName, environmentName, certificateName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, environmentName, certificateName, options }, createOrUpdateOperationSpec$2);
    }
    /**
    ...
    delete(resourceGroupName, environmentName, certificateName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, environmentName, certificateName, options }, deleteOperationSpec$2);
    }
    /**
...
class ContainerAppsSourceControlsImpl {
    ...
    beginDelete(resourceGroupName, containerAppName, sourceControlName, options) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, containerAppName, sourceControlName, options }, deleteOperationSpec);
            const poller = new coreLro.LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
