...
function listContainerAppsSecrets() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.daprComponents.listSecrets(resourceGroupName, environmentName, componentName);
        console.log(result);
    });
}
listContainerAppsSecrets().catch(console.error);
//# sourceMappingURL=daprComponentsListSecretsSample.js.map