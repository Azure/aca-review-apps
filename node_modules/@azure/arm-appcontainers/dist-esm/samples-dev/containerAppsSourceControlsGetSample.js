 ...
 */
function getContainerAppSourceControl() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.containerAppsSourceControls.get(resourceGroupName, containerAppName, sourceControlName);
        console.log(result);
    });
}
getContainerAppSourceControl().catch(console.error);
//# sourceMappingURL=containerAppsSourceControlsGetSample.js.map