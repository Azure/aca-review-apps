 ...
 */
function createOrUpdateDaprComponent() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.daprComponents.createOrUpdate(resourceGroupName, environmentName, componentName, daprComponentEnvelope);
        console.log(result);
    });
}
createOrUpdateDaprComponent().catch(console.error);
//# sourceMappingURL=daprComponentsCreateOrUpdateSample.js.map