 ...
 */
function patchManagedEnvironment() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.managedEnvironments.beginUpdateAndWait(resourceGroupName, environmentName, environmentEnvelope);
        console.log(result);
    });
}
patchManagedEnvironment().catch(console.error);
//# sourceMappingURL=managedEnvironmentsUpdateSample.js.map