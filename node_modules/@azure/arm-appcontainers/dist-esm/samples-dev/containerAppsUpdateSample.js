...
function patchContainerApp() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.containerApps.beginUpdateAndWait(resourceGroupName, containerAppName, containerAppEnvelope);
        console.log(result);
    });
}
patchContainerApp().catch(console.error);
//# sourceMappingURL=containerAppsUpdateSample.js.map