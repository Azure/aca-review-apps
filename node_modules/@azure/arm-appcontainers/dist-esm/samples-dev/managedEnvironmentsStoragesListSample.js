 ...
 */
function listEnvironmentsStoragesBySubscription() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.managedEnvironmentsStorages.list(resourceGroupName, environmentName);
        console.log(result);
    });
}
listEnvironmentsStoragesBySubscription().catch(console.error);
//# sourceMappingURL=managedEnvironmentsStoragesListSample.js.map