...
function getDaprComponent() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.daprComponents.get(resourceGroupName, environmentName, componentName);
        console.log(result);
    });
}
getDaprComponent().catch(console.error);
//# sourceMappingURL=daprComponentsGetSample.js.map