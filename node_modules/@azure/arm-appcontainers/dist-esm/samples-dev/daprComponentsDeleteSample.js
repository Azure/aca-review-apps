...
function deleteDaprComponent() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.daprComponents.delete(resourceGroupName, environmentName, componentName);
        console.log(result);
    });
}
deleteDaprComponent().catch(console.error);
//# sourceMappingURL=daprComponentsDeleteSample.js.map