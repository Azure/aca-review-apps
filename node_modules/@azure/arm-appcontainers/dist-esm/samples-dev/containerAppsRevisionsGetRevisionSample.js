 ...
 */
function getContainerAppRevision() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.containerAppsRevisions.getRevision(resourceGroupName, containerAppName, revisionName);
        console.log(result);
    });
}
getContainerAppRevision().catch(console.error);
//# sourceMappingURL=containerAppsRevisionsGetRevisionSample.js.map