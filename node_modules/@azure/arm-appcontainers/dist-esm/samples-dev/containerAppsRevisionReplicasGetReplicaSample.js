 ...
 */
function getContainerAppRevisionReplica() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.containerAppsRevisionReplicas.getReplica(resourceGroupName, containerAppName, revisionName, replicaName);
        console.log(result);
    });
}
getContainerAppRevisionReplica().catch(console.error);
//# sourceMappingURL=containerAppsRevisionReplicasGetReplicaSample.js.map