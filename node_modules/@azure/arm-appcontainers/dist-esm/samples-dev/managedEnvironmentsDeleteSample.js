 ...
 */
function deleteEnvironmentByName() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.managedEnvironments.beginDeleteAndWait(resourceGroupName, environmentName);
        console.log(result);
    });
}
deleteEnvironmentByName().catch(console.error);
//# sourceMappingURL=managedEnvironmentsDeleteSample.js.map